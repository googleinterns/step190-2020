...
public class PollingStationTest {
    ...
    JSONObject pollingStationJsonObject =
        new JSONObject(
            "{\"id\": \"pollingId\","
                ...
                + "\"startDate\": \"start\",\"endDate\": \"end\", \"sources\": ["
                + "{\"name\": \"Voting Information Project\", \"official\": true}]}");
  ...
  @Test
  public void testFromJSONObject_withSources() throws Exception {
    JSONObject pollingStationJsonObject =
        new JSONObject(
            "{\"id\": \"pollingId\","
                + "\"address\": {\"locationName\": \"name\",\"line1\": \"1\","
  ...
  public void testFromEntity() throws Exception {
    ...
    entity.setProperty("sources", new ArrayList<String>());
